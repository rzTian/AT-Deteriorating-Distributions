...
'''
Code copied and revised from https://github.com/jiweibo/ImageNet/blob/master/models/resnet.py
'''
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10):  # We have 10 classes in our settings
    ...
    def forward(self, x):
        # Data preprocessing as a part of model
        # x = vision_F.normalize(x, (0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010))
